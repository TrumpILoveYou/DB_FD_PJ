...
-- Increase collection count after a new collection is inserted
...
-- Increase sales count after a new order is inserted
...
-- Update order status every minute for orders older than 2 minutes
